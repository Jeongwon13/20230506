...
document.getElementById("select1").addEventListener("click", function(){
    ...
    $.ajax({
        ...
        success : function(abdds){ 

            console.log(abdds); // JS 객체 형태 문자열
            ...
            if(abdds != null){ // 회원 정보 존재 O
                ...
                li1.innerText = "이메일 : " + abdds.memberEmail;

                const li2 = document.createElement("li");
                li2.innerText = "닉네임 : " + abdds.memberNickname;

                const li3 = document.createElement("li");
                li3.innerText = "전화번호 : " + abdds.memberTel;

                const li4 = document.createElement("li");
                li4.innerText = "주소 : " + abdds.memberAddress;

                const li5 = document.createElement("li");
                li5.innerText = "가입일 : " + abdds.enrollDate;
